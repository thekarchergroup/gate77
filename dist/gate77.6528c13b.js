...
var _spotlightBundleJs = require("./spotlight/dist/spotlight.bundle.js");
// gallery
const gallery = [
    {
        src: "DSC07711.jpg"
...
},{"../scss/master.scss":"gpsI5","./jquery":"1Dm9r","./counters":"XKR29","./spotlight/dist/spotlight.bundle.js":"91sZC"}],"gpsI5":[function() {},{}],"1Dm9r":[function(require,module,exports,__globalThis) {
// jQuery
...
},{}],"XKR29":[function(require,module,exports,__globalThis) {
    ...
    let io = new IntersectionObserver((entries, observer)=>{
        entries.forEach((entry)=>{
            if (entry.isIntersecting) {
                // increment counters
                for(let i = 0; i <= end; i++)setTimeout(()=>{
                    counter.innerHTML = i;
                }, i * counterSpeed);
...
},{"intersection-observer":"lkhT7"}],"lkhT7":[function(require,module,exports,__globalThis) {
/**
...
},{}],"91sZC":[function(require,module,exports,__globalThis) {
/**
 ...
 */ (function() {
    ...
    var n = "theme download play page close autofit zoom-in zoom-out prev next fullscreen".split(" "), ha = {
        page: 1,
        close: 1,
        autofit: 1,
        "zoom-in": 1,
    ...
    function tb(a) {
        ...
        if (N) x && V(), Aa && d(N, Aa, !0), rb(!0), J && d(N, J), Ja && g(N, "opacity", 1), Ia && g(N, "transform", ""), g(N, "visibility", "visible"), Q && (La.src = Q), H && ub(R);
            ...
            }, N.poster = D.poster, N.preload = Da ? "auto" : "metadata", N.controls = Y("controls", !0), N.autoplay = D.autoplay, N.h = Y("inline"), N.muted = Y("muted"), N.src = P.src, L.appendChild(N);
            else {
                if ("node" === b) {
                    N = P.src;
...
},{}]},["6DHTQ","6kb64"], "6kb64", "parcelRequiredecf", {})

//# sourceMappingURL=gate77.6528c13b.js.map
